...
class AppleClientSecretGeneratorTest {
    ...
    void Apple_client_secret은_ES256과_필수_claim을_가진다() throws Exception {
        ...
        AppleClientSecretGenerator generator =
                new AppleClientSecretGenerator("TEAM_ID", "com.finditem.web", "KEY_ID", privateKeyBase64);
    ...
    void 유효하지_않은_개인키면_Apple_client_secret_생성_예외를_던진다() {
        // given
        AppleClientSecretGenerator generator =
                new AppleClientSecretGenerator("TEAM_ID", "com.finditem.web", "KEY_ID", "invalid-private-key");
