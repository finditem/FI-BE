...
CREATE TABLE IF NOT EXISTS `notification_settings` (
  ...
  `browser_notification_enabled` bit(1) DEFAULT NULL,
  `category_enabled` bit(1) DEFAULT NULL,
  `chat_enabled` bit(1) DEFAULT NULL,
  `comment_enabled` bit(1) DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `favorite_enabled` bit(1) DEFAULT NULL,
  `inquiry_reply_enabled` bit(1) DEFAULT NULL,
  `notice_enabled` bit(1) DEFAULT NULL,
  `report_result_enabled` bit(1) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `user_id` bigint NOT NULL,
