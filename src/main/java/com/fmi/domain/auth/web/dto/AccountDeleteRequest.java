...
public class AccountDeleteRequest {
    ...
    @NotEmpty(message = "탈퇴 사유를 최소 1개 선택해주세요") @Size(max = 3, message = "탈퇴 사유는 최대 3개까지 선택 가능합니다") private List<WithdrawalReason> reasons;

    @Schema(description = "기타 사유 (reasons에 OTHER가 포함된 경우 필수)", example = "직접 입력한 사유")
    @Size(max = 500, message = "기타 사유는 최대 500자까지 입력 가능합니다") private String otherReason;
}
