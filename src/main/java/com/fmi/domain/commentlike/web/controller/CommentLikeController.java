...
public class CommentLikeController {
                ...
                content =
                        @Content(
                                ...
                                examples =
                                        @ExampleObject(
                                                value =
                                                        "{\"isSuccess\": true, \"code\": \"COMMON200\", \"message\": \"성공\", \"result\": true}"))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "401",
    ...
    public ResponseEntity<ApiResponse<Boolean>> createLike(
    ...
    @ApiResponses({
                ...
                content =
                        @Content(
                                ...
                                examples =
                                        @ExampleObject(
                                                value =
                                                        "{\"isSuccess\": true, \"code\": \"COMMON200\", \"message\": \"성공\", \"result\": false}"))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "401",
                description = "COMMON401: 인증이 필요합니다",
                content = @Content),
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "404",
                description = "COMMENT404-LIKE_NOT_FOUND: 존재하지 않는 댓글 좋아요입니다.",
                content = @Content),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "500",
                description = "COMMON500: 서버 에러",
    ...
    public ResponseEntity<ApiResponse<Boolean>> deleteLike(
            @PathVariable Long commentId, @AuthenticationPrincipal UserDetails userDetails) {
        if (Objects.isNull(userDetails)) {
            throw new GeneralException(ErrorStatus._UNAUTHORIZED);
        }
