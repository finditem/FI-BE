...
public final class PostConverter {
    ...
    public static PostGetResponse toGetResponse(
            Post post,
            boolean isFavorite,
            long viewCount,
            boolean isNew,
            ...
            long favoriteCount,
            boolean isMine,
            List<PostImageResponse> imageList,
    ...
    public static PostBriefResponse toPostBriefResponse(
            Post post, boolean isFavorite, String thumbnailImageUrl, Long favoriteCount, Integer imageCount) {
