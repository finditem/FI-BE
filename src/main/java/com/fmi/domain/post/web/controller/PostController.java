...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<PostPageResponse>> searchPostFilterOrSort(
        ...
        PostPageResponse response = postQueryService.getPostListByFilterOrSort(
                postType, postStatus, category, address, sortType, cursor, size, userDetails);

        return ResponseEntity.ok(ApiResponse.onSuccess(response));
    }

    @GetMapping("/search/keyword")
    @Operation(summary = "게시글 키워드 검색 (무한스크롤)", description = """
    ...
    public ResponseEntity<ApiResponse<PostPageResponse>> searchByKeyword(
    ...
    public ResponseEntity<ApiResponse<PostGetResponse>> getPost(
            @PathVariable Long postId, @AuthenticationPrincipal UserDetails userDetails, HttpServletRequest request) {
    ...
    @Operation(summary = "게시글 반경(radius) 수정", description = """
    ...
    public ResponseEntity<Void> updateRadius(
            @PathVariable Long postId, @RequestBody PostRadiusUpdateRequest request, UserDetails userDetails) {
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content =
                        @Content(
                                mediaType = "application/json",
                                array = @ArraySchema(schema = @Schema(implementation = PostSimilarResponse.class)),
                                examples = @ExampleObject(value = """
                                            {
                                              "isSuccess": true,
                                              "code": "COMMON200",
    ...
    public ResponseEntity<ApiResponse<List<PostSimilarResponse>>> getSimilarList(
            @PathVariable Long postId, @AuthenticationPrincipal UserDetails userDetails) {
    ...
    @Operation(summary = "임시 저장 게시글 생성/수정", description = """
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "400",
                description = "잘못된 요청 (multipart 형식 오류/파라미터 오류)",
                content = @Content),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "401",
                description = "인증 실패",
    ...
    public ResponseEntity<ApiResponse<Void>> saveTemporaryPost(
            @RequestPart("request") TemporaryPostCreateRequest request,
            @AuthenticationPrincipal UserDetails userDetails,
    ...
    @GetMapping("/temp")
    @Operation(summary = "내 임시 저장 게시글 조회", description = """
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content =
                        @Content(
                                mediaType = "application/json",
                                examples = {
                                    @ExampleObject(name = "임시 저장 존재", value = """
                                                    {
                                                      "isSuccess": true,
                                                      "code": "COMMON200",
                                                      "message": "성공",
                                                    ...
                                                    """),
                                    @ExampleObject(name = "임시 저장 없음", value = """
                                                    {
                                                      "isSuccess": true,
                                                      "code": "COMMON200",
                                                      "message": "성공",
    ...
    public ResponseEntity<ApiResponse<TemporaryPostResponse>> getTemporaryPost(
            @AuthenticationPrincipal UserDetails userDetails) {
    ...
    @DeleteMapping("/temp")
    @Operation(summary = "내 임시 저장 게시글 삭제", description = """
    ...
    public ResponseEntity<ApiResponse<Void>> updateFound(
            @PathVariable Long postId,
